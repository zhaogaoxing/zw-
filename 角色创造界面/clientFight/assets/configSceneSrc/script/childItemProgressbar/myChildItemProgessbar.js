...
cc.Class({
    ...
    hidePlusBtnHandler: function(){
        switch(this.curPos){
            case pos.earth: this._hidePlusBtn('earthPlusBtn');break;
            case pos.water: this._hidePlusBtn('waterPlusBtn');break;
            case pos.fire: this._hidePlusBtn('firePlusBtn');break;
            case pos.wind: this._hidePlusBtn('windPlusBtn');break;
        }
    },
    
    hideMinusBtnHandler: function(){
        switch(this.curPos){
            case pos.earth: this._hideMinusBtn('earthMinusBtn');break;
            case pos.water: this._hideMinusBtn('waterMinusBtn');break;
            case pos.fire: this._hideMinusBtn('fireMinusBtn');break;
            case pos.wind: this._hideMinusBtn('windMinusBtn');break;
        }
    },
    ...
    showMinusBtnHandler: function(){
        ...
        switch(this.curPos){
            case pos.earth: this._showMinusBtn('earthMinusBtn');break;
            case pos.water: this._showMinusBtn('waterMinusBtn');break;
            case pos.fire: this._showMinusBtn('fireMinusBtn');break;
            case pos.wind: this._showMinusBtn('windMinusBtn');break;
        }
    },
    
    showPlusBtnHandler: function(){
        switch(this.curPos){
            case pos.earth: this._showPlusBtn('earthPlusBtn');break;
            case pos.water: this._showPlusBtn('waterPlusBtn');break;
            case pos.fire: this._showPlusBtn('firePlusBtn');break;
            case pos.wind: this._showPlusBtn('windPlusBtn');break;
        }
    },
