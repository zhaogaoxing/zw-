    ...
    changeStatus: function(){
        ...
        switch(this.curDir){
            case dir.plus:
                            ...
                            switch(this.curPos){
                                case pos.earth:this._ItemPlus('earth');break;
                                case pos.water:this._ItemPlus('water');break;
                                case pos.fire:this._ItemPlus('fire');break;
                                case pos.wind:this._ItemPlus('wind');break;
                            }
            break;
            case dir.minus:
                             cc.find('Canvas/config/AttributePoint').getComponent("myAttributeStateLabel").plus();
                            switch(this.curPos){
                                case pos.earth:this._ItemMinus('earth');break;
                                case pos.water:this._ItemMinus('water');break;
                                case pos.fire:this._ItemMinus('fire');break;
                                case pos.wind:this._ItemMinus('wind');break;
                            }
            break;
        }
    },
